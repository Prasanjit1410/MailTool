...
public class SESContentBuilder {
    ...
    private final static Logger logger = LoggerFactory.getLogger(SESContentBuilder.class);
     ...
     */
    protected Destination getDestination(SESMailMessage email){
     ...
     */
    protected MimeMessage addRecipients(MimeMessage message, SESMailMessage email) throws MessagingException, javax.mail.MessagingException {
     ...
     */
    protected Message getAWSFormattedMessage(SESMailMessage email){
     ...
     * @return SES Message Object that can be used by the AWS SES API.
     */
    protected Message getAWSFormattedMessage(SESMailMessage email, String displayName, String emailAddress){
     ...
     * @return SES Message Object that can be used by the AWS SES API.
     */
    protected Message getAWSFormattedMessage(SESMailMessage email, String footerText){
        if(null != footerText)
     ...
     * @return SES Message Object that can be used by the AWS SES API.
     */
    protected Message getAWSFormattedMessage(SESMailMessage email, String footerText, String displayName, String emailAddress){
        this.createAdditionalFooter(displayName, emailAddress);
        if(null != footerText)
            this.footerText += footerText;
        Message message = new Message();
     ...
     */
    protected MimeMultipart buildMimeBody(SESMailMessage  email) throws MessagingException {
     ...
     * @throws MessagingException
     */
    protected MimeMultipart buildMimeBody(SESMailMessage email, String footerText) throws MessagingException {
     ...
     * @throws MessagingException
     */
    protected MimeMultipart buildMimeBody(SESMailMessage email, String displayName, String emailAddress) throws MessagingException {
     ...
     * @throws MessagingException
     */
    protected MimeMultipart buildMimeBody(SESMailMessage email, String footerText, String displayName, String emailAddress) throws MessagingException, javax.mail.MessagingException {
    ...
    private void createAdditionalFooter(String displayName, String emailAddress){
        String content = "<html><body><p><strong>Important Information: </strong>"
                + "This email was sent to you on behalf of naveen. "
